...
/* Title of the Blog */
#blog-title     { left:90px; position:fixed; top:24px; max-width:237px; }
...
/* Top Menu */
.map-menu-top                       { position:fixed; right:124px; top:24px; z-index:10; }
.map-menu-top ul                    { list-style:none; margin:0; padding:0; }
.map-menu-top ul li                 { float:left; padding:0; }
.map-menu-top ul li a               { background:<?php echo $bgColor; ?>; color:<?php echo $fontColor; ?>; display:block; padding:6px 9px; text-decoration:none; font-weight:bold; }
...
.map-menu-side ul li a              { background:<?php echo $bgColor; ?>; color:<?php echo $fontColor; ?>; display:block; padding:6px 9px; text-decoration:none; font-weight:bold; }
...
#searchform input[type="text"] { background:none; border:none; color:<?php echo $fontColor; ?>; float:left; height:28px; margin:0; padding:0 10px; width:140px; font-weight:bold; }
...
#filters ul { list-style:none; float:left; margin:0; padding:0; width:20%; font-weight:bold;}
#filters ul ul { border:none; float:none; width:auto; font-weight:bold;}
#filters ul li { margin:0 6px 6px 0; width:100%; font-weight:bold;}
#filters ul.children li { margin-left:18px; }

/* Posts Loader */
#posts-loader { display:none; background:<?php echo $bgColor; ?>; font-family:"Bebas"; font-size:22px; padding:4px 4px 0 4px; position:fixed; right:0; top:110px; }
#posts-loader span { font-size:18px; }

/* Results */
#toggle-results { background:<?php echo $bgColor; ?>; cursor:pointer; padding:4px 4px 0 4px; position:fixed; right:0; top:10px; }
#results { background:<?php echo $bgColor; ?>; color:<?php echo $fontColor; ?>; display:none; max-height:60%; overflow:auto; padding:9px; position:fixed; right:35px; top:10px; width:30%; }
...
/* Ballon */
.balloon            { background:#fff; color:<?php echo $bgColor; ?>; padding:18px; width:300px; }
...
#post_overlay a#close_post_overlay          { background:<?php echo $bgColor; ?>; cursor:pointer; padding:4px 4px 0 4px; position:absolute; right:0; top:70px; z-index:1000; }
#post_overlay a#close_post_overlay:hover    { background:<?php echo $themeColor; ?>; }
#post_overlay .entry                        { background:<?php echo $bgColor; ?> !important; height:490px; overflow:auto; padding:36px; position:absolute; right:35px; top:70px; width:67%; z-index:1000; }
